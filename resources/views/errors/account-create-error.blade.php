<div id="account-create-error" class="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center">
    <div class="bg-white shadow-lg rounded-lg max-w-md w-full p-4">

        
            <div class="mt-4 text-center">
                <h2 class="text-xl m-2">This account already exists!</h2>
            </div>
