<div id="account-create" class="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center">
    <div class="bg-white shadow-lg rounded-lg max-w-md w-full p-4">
        ...
        <form hx-post="api/accounts/create" hx-trigger="submit" hx-target="#accounts-list" hx-swap="innerHTML">
            ...
            <div class="flex justify-end mt-4">
                ...
                <button type="button" onclick="document.getElementById('account-create').classList.add('hidden')" 
